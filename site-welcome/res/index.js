...
function reset() {
	...
	window.document.body.style['backgroundColor'] = theme[0];
...
function createInstructions() {
	...
	text.innerHTML = '<span style="color:' + theme[0] + ';font-size:40px;">Hi there!</span><br /><br /><span style="font-size:15px;">'+
		'<strong>Welcome to my website</strong><br />'+
		'<br />Nothing here.<br />You can visit my github page!</span>';
...
function createGithubAvatar() {
	...
	text.innerHTML = '<span style="color:' + theme[0] + ';">' +
		'<a href="https://github.com/hetianyi"><svg viewBox="0 0 16 16" version="1.1" width="260" height="260" aria-hidden="true">' +
